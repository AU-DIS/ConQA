...
python experiment.py -z coco5k -s blip -m coco-large -e coco5k -r hit_rate@1,hit_rate@5,hit_rate@10
python experiment.py -z coco5k -s blip2 -m coco -e coco5k -r hit_rate@1,hit_rate@5,hit_rate@10
