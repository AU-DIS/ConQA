...
python experiment.py -z small -s blip -m pretrain-large -e abs --save_experiment
python experiment.py -z small -s blip -m pretrain-large -e nonabs --save_experiment
python experiment.py -z small -s blip -m pretrain-large -e gptj6-abs --save_experiment
python experiment.py -z small -s blip -m pretrain-large -e gptj6-nonabs --save_experiment
python experiment.py -z small -s blip -m pretrain-large -e extcoco --save_experiment

python experiment.py -z small -s blip2 -m pretrain -e abs --save_experiment
python experiment.py -z small -s blip2 -m pretrain -e nonabs --save_experiment
python experiment.py -z small -s blip2 -m pretrain -e gptj6-abs --save_experiment
python experiment.py -z small -s blip2 -m pretrain -e gptj6-nonabs --save_experiment
python experiment.py -z small -s blip2 -m pretrain -e extcoco --save_experiment
